...
public class HologramScreenRenderer extends SafeBlockEntityRenderer<HologramScreenTE> {
    ...
    public HologramScreenRenderer(BlockEntityRendererProvider.Context context){
        super();
    }
    ...
    private static void renderToBuffer(DirectVertexBuffer vbo, int size, Consumer<DirectFixedWidthFontRenderer.QuadEmitter> draw) {
        var sink = ShaderMod.get().getQuadEmitter(size, HologramScreenRenderer::getBuffer);
